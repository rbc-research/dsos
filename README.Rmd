...
The package is also on [CRAN](https://CRAN.R-project.org), although that release
lags behind. I recommend the package on GitHub over CRAN for now. The package
on CRAN (v0.1.0) will eventually be updated. From CRAN, install the package
with:
...
prediction uncertainty. Users can easily plug in their own scores via the
scoring function.
